...
kubectl apply -f https://raw.githubusercontent.com/vilvamani/spring-boot-swagger2/master/password.yaml --namespace=aks-boomi-molecule --kubeconfig=/root/.kube/config
fi
